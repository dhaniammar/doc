            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 ">
                        ...
                        <a href="<?= base_url("pembelian/faktur/".$pembelian->id); ?>" class="btn btn-primary float-right" target="_blank">Cetak Invoice</a>
                        <a href="<?= base_url("pembelian/surat/".$pembelian->id); ?>" class="btn btn-danger float-right mr-2" target="_blank">Cetak Surat</a>
                    </div>
